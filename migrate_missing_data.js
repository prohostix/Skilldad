...
async function copyMissingData() {
    ...
    try {
        ...
        for (const colName of collectionNames) {
            ...
            // Exclude gridfs buckets or unnecessary things if any, but let's migrate everything
            ...
            console.log(`Collection: ${colName.padEnd(25)} | Inserted: ${inserted.toString().padEnd(4)} | Skipped: ${skipped.toString().padEnd(4)}`);
        ...
        console.log(`Total existing documents skipped: ${totalSkipped}`);
