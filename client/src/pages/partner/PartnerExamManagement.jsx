                                ...
                                {(!examData.linkedPaper || examData.deploymentMode === 'new') ? (
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <select required value={examData.course} onChange={e => setExamData({...examData, course: e.target.value})} className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl focus:border-primary transition-all text-white/60 text-sm">
