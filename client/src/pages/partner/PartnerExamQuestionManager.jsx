...
const PartnerExamQuestionManager = () => {
    ...
    const fetchExamDetails = async () => {
        try {
            ...
            setExam(data.exam || data.data || data);
            setLoading(false);
        } catch (err) {
    ...
    if (error || !exam) {
        return (
            <div className="space-y-6 max-w-7xl mx-auto">
                <ModernButton onClick={() => navigate('/partner/exams')} variant="secondary">
    ...
    return (
        <div className="space-y-6 pb-20 max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
                <div>
                    <ModernButton onClick={() => navigate('/partner/exams')} variant="secondary" className="mb-4">
                        <ArrowLeft size={18} className="mr-2" />
                        Back to Exam Management
                    </ModernButton>
...
export default PartnerExamQuestionManager;
