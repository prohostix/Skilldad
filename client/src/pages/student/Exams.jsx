...
const Exams = () => {
    ...
    if (activeExam && examStarted) {
        ...
        return (
            <div className="min-h-screen bg-[#f8fafc] dark:bg-[#060112] text-slate-900 dark:text-white flex flex-col font-inter">
                {/* Standardized LMS Header */}
                <header className="min-h-14 bg-white dark:bg-[#0a031a] border-b border-slate-200 dark:border-white/10 flex flex-wrap items-center justify-between gap-2 px-3 sm:px-6 py-2 sm:py-0 sticky top-0 z-50 shadow-sm">
                    <div className="flex items-center gap-2 sm:gap-4 min-w-0">
                        <div className="bg-primary/10 p-1.5 rounded-lg shrink-0">
                            <Activity size={18} className="text-primary" />
                        </div>
                        <div className="min-w-0">
                            <h1 className="text-sm font-bold text-slate-800 dark:text-white truncate max-w-[140px] sm:max-w-[200px] md:max-w-[400px]">
                                {activeExam.title}
                            </h1>
                            <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider truncate max-w-[140px] sm:max-w-none">
                    ...
                    <div className="flex items-center gap-2 sm:gap-6 shrink-0">
                        <div className="flex items-center gap-1.5 sm:gap-3 py-1 sm:py-1.5 px-2.5 sm:px-4 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-full">
                            <Clock size={16} className={timeRemaining < 300 ? "text-red-500 animate-pulse" : "text-slate-400"} />
                            <span className={`font-mono text-xs sm:text-sm font-bold ${timeRemaining < 300 ? "text-red-600" : "text-slate-700 dark:text-slate-300"}`}>
                                {formatTime(timeRemaining)}
                            </span>
                        </div>
                        <ModernButton
                            onClick={() => setShowSubmitModal(true)}
                            className="!bg-emerald-600 !text-white !px-3 sm:!px-6 !h-8 sm:!h-10 !text-[10px] sm:!text-xs !rounded-full shadow-lg shadow-emerald-600/20"
                        >
                            Submit Exam
                        </ModernButton>
                    </div>
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <main className="flex-1 overflow-y-auto bg-slate-50 dark:bg-transparent">
                        <div className="max-w-3xl mx-auto p-2 md:p-4 space-y-3">
                            ...
                            <motion.div
                                ...
                                className="bg-white dark:bg-[#0d0722] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-4 md:p-5 space-y-3"
                            >
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {flaggedQuestions.has(question._id || question.id) && (
                                                <span className="px-2.5 py-1 bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 text-[10px] font-bold rounded-md uppercase tracking-wider flex items-center gap-1">
                                        ...
                                        <button
                                            ...
                                            className={`p-2 rounded-lg transition-all ${flaggedQuestions.has(question._id || question.id)
                                                    ...
                                                    : 'text-slate-300 hover:text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5'
                                                }`}
                                ...
                                {question.questionType === 'descriptive' ? (
                                    <div className="space-y-4">
                                        ...
                                        <textarea
                                            ...
                                            rows={8}
                                            className="w-full p-4 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-slate-700 dark:text-white placeholder-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all resize-none font-medium leading-relaxed text-sm"
                                        />
                                    </div>
                                ) : (
                                                ...
                                                <button
                                                    ...
                                                    className={`
                                                        ...
                                                        ${isSelected ?
                                                            ...
                                                            'bg-white dark:bg-white/[0.02] border-slate-100 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/5'}
                                                    `}
                                                >
                                                    <div className={`
                                                        w-7 h-7 rounded-lg flex items-center justify-center mr-4 text-[10px] font-bold transition-all
                                                        ${isSelected ? 'bg-primary text-white' : 'bg-slate-100 dark:bg-white/10 text-slate-400 group-hover:bg-slate-200 dark:group-hover:bg-white/15 group-hover:text-slate-600 dark:group-hover:text-slate-200'}
                                                    `}>
                                                        {String.fromCharCode(65 + index)}
                                                    </div>
                                                    <span className={`text-[13px] font-medium flex-1 text-left ${isSelected ? 'text-slate-900 dark:text-white' : 'text-slate-600 dark:text-slate-300'}`}>
                                                        {typeof option === 'object' ? option.text : option}
                                                    </span>
                                                    <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${isSelected ? 'border-primary bg-primary text-white' : 'border-slate-200 dark:border-white/20 bg-white dark:bg-transparent'
                                                        }`}>
                            ...
                            <div className="flex items-center justify-between pb-4">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-6 py-3 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                                >
                    ...
                    <aside className="hidden md:flex w-60 lg:w-72 bg-white dark:bg-[#0a031a] border-l border-slate-200 dark:border-white/10 flex-col">
                                        ...
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${isCurrent ? 'ring-2 ring-primary ring-offset-2 bg-primary text-white' :
                                                    isAnswered ? 'bg-emerald-50 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-500/30' :
                                                        'bg-slate-50 dark:bg-white/5 text-slate-400 border border-slate-100 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/10'}
                                            `}
                                        >
                                            {idx + 1}
                                            {isFlagged && (
                        ...
                        <div className="p-4 space-y-5">
                            ...
                            <div className="bg-slate-50 dark:bg-white/5 rounded-xl p-3.5 border border-slate-100 dark:border-white/10">
                                <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2.5">Summary</h4>
                                <div className="space-y-1.5">
                                    <div className="flex justify-between text-[11px]">
                                        <span className="text-slate-500 dark:text-slate-400">Total</span>
                                        <span className="font-bold text-slate-700 dark:text-slate-200">{activeExam.questions.length}</span>
                                    </div>
                                    <div className="flex justify-between text-[11px]">
                        ...
                        <div className="mt-auto p-4 border-t border-slate-100 dark:border-white/10">
                    ...
                    {showSubmitModal && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 backdrop-blur-sm p-4">
                            <motion.div
                                ...
                                className="bg-white dark:bg-[#0e0722] rounded-2xl border border-slate-200 dark:border-white/10 shadow-2xl p-6 sm:p-7 max-w-md w-full max-h-[90vh] overflow-y-auto text-slate-900 dark:text-white space-y-6"
                            >
                                <div className="flex items-start justify-between">
                                    ...
                                    <button
                                        ...
                                        className="p-1 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
                                    >
                                        <X size={18} />
                                    </button>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-xl font-bold font-space text-slate-900 dark:text-white">
                                ...
                                <div className="grid grid-cols-3 gap-3 p-3.5 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 text-center">
                                    <div>
                ...
                {showSubmitModal && activeExam && (
                    ...
                    >
                        <motion.div
                            ...
                            className="w-full max-w-md max-h-[90vh] overflow-y-auto bg-[#0F1420] border border-white/10 rounded-2xl shadow-2xl text-left"
                        >
