...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-alyra-gradient flex items-start justify-center pt-24 pb-12 px-6 relative overflow-hidden">
            ...
            <button
                onClick={() => navigate('/')}
                className="fixed top-24 left-6 z-50 p-3 rounded-xl bg-white/5 border border-white/10 text-purple-500 hover:bg-white/10 hover:border-primary/30 transition-all duration-300 backdrop-blur-sm"
                title="Go to Home"
            >
                <Home size={20} />
            </button>
