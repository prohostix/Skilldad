                            ...
                            <div className="mt-8 space-y-12">
                                ...
                                <div className="relative mt-8">
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-5 z-10" style={{ backgroundColor: '#FAF9F6' }}>
                                        <h3 className="font-extrabold tracking-widest uppercase text-[14px] md:text-[16px] whitespace-nowrap !text-[#4C1D95]">YOUR JOURNEY</h3>
                                    </div>
                                        ...
                                        <div className="flex flex-col md:flex-row items-start md:items-start justify-between w-full relative z-10">
                                            {[
                                                ...
                                                <div key={idx} className="flex flex-row md:flex-col items-center md:text-center flex-1 relative px-1 py-3 md:py-0 w-full md:w-auto gap-4 md:gap-0">
                                                    ...
                                                    {idx < arr.length - 1 && (
                                                        <div className="hidden md:block absolute top-[32px] -right-3 -translate-y-1/2 z-0" style={{ color: '#4C1D95' }}>
