...
const AboutUs = () => {
    ...
    return (
        <div className="min-h-screen about-us-page bg-[#080512] [.light-mode_&]:!bg-white text-white [.light-mode_&]:!text-slate-800 overflow-hidden relative font-sans transition-colors duration-300">
            ...
            <section className="relative pt-8 sm:pt-12 md:pt-14 pb-16 md:pb-20 px-4 sm:px-6 lg:px-12 overflow-hidden bg-gradient-to-br from-white via-slate-50 to-[#FAF8FF] [.dark-mode_&]:!from-[#080512] [.dark-mode_&]:!via-[#0E091D] [.dark-mode_&]:!to-[#150D2B] border-b border-slate-100 [.dark-mode_&]:!border-purple-900/30">
