...
const HeroFlowingWave = () => {
    ...
    return (
        <div
            className="absolute right-0 top-0 bottom-0 w-[380px] sm:w-[480px] md:w-[560px] lg:w-[620px] xl:w-[680px] pointer-events-none select-none z-0 overflow-visible hidden lg:flex items-center justify-end"
            aria-hidden="true"
        >
