...
const setupDemo = async () => {
    try {
        ...
        // Check if Sara Wilson exists
        let saraWilson = await User.findOne({ email: 'sara.wilson@university.edu' });
        
        if (!saraWilson) {
            console.log('Creating Sara Wilson user...');
            const salt = await bcrypt.genSalt(10);
            const hashedPassword = await bcrypt.hash('password123', salt);
            
            saraWilson = new User({
                name: 'Sara Wilson',
                email: 'sara.wilson@university.edu',
                password: hashedPassword,
                role: 'university',
                isVerified: true
            });
            await saraWilson.save();
            console.log('✅ Sara Wilson created');
        } else {
            console.log('✅ Sara Wilson already exists');
        }
        ...
        if (existingCourse) {
            console.log('⚠️  Demo course already exists. Deleting old course...');
            await InteractiveContent.deleteMany({ course: existingCourse._id });
        ...
        await demoCourse.save();
        console.log('✅ Module 1: HTML & CSS Fundamentals');
        ...
        const htmlQuiz = new InteractiveContent({
            ...
            instructions: 'Answer all questions to the best of your ability. You have 15 minutes and 3 attempts.',
            type: 'quiz',
            timeLimit: 15,
            attemptsAllowed: 3,
            passingScore: 70,
        ...
        await htmlQuiz.save();
        console.log('  ✓ HTML Fundamentals Quiz');
        ...
        const cssExercise = new InteractiveContent({
            ...
            instructions: 'Complete the following CSS exercises. Take your time and refer to the videos if needed.',
            type: 'exercise',
            attemptsAllowed: -1,
        ...
        console.log('  ✓ CSS Styling Exercise');
        ...
        await demoCourse.save();
        console.log('✅ Module 2: JavaScript Essentials');
        ...
        const jsQuiz = new InteractiveContent({
            ...
            instructions: 'Answer all questions about JavaScript basics. You have 20 minutes and 3 attempts.',
            type: 'quiz',
            timeLimit: 20,
            attemptsAllowed: 3,
            passingScore: 75,
        ...
        const jsPractice = new InteractiveContent({
            ...
            instructions: 'Write JavaScript functions according to the specifications. Test your code before submitting.',
            type: 'practice',
            attemptsAllowed: -1,
            showSolutionAfter: 'submission',
            questions: [
        ...
        console.log('  ✓ JavaScript Functions Practice');
        ...
        await demoCourse.save();
        console.log('✅ Module 3: React Fundamentals');
        ...
        const reactQuiz = new InteractiveContent({
            ...
            instructions: 'Answer all questions about React fundamentals. You have 25 minutes and 3 attempts.',
            type: 'quiz',
            timeLimit: 25,
            attemptsAllowed: 3,
            passingScore: 70,
        ...
        const reactProject = new InteractiveContent({
            ...
            instructions: 'Build a complete Todo application with add, complete, delete, and filter features. Submit your GitHub repository link.',
            type: 'practice',
            attemptsAllowed: -1,
        ...
        console.log('  ✓ Build a Todo App Project');
        ...
        await demoCourse.save();
        console.log('✅ Module 4: Backend Development with Node.js');
        ...
        const nodeQuiz = new InteractiveContent({
            ...
            instructions: 'Answer all questions about Node.js and Express. You have 20 minutes and 3 attempts.',
            type: 'quiz',
            timeLimit: 20,
            attemptsAllowed: 3,
            passingScore: 75,
        ...
        await nodeQuiz.save();
        console.log('  ✓ Node.js & Express Quiz');
        ...
        const apiProject = new InteractiveContent({
            ...
            instructions: 'Build a complete REST API with authentication and validation. Submit your GitHub repository link and API documentation.',
            type: 'practice',
            attemptsAllowed: -1,
            showSolutionAfter: 'never',
            questions: [
        ...
        console.log('  ✓ Build a REST API Project');
        ...
        console.log('  Instructor:', saraWilson.name, '(' + saraWilson.email + ')');
        console.log('  Price: ₹' + demoCourse.price);
        console.log('  Category:', demoCourse.category);
        console.log('  Level:', demoCourse.level);
        console.log('\n📚 Content Breakdown:');
        ...
        console.log('  Total Interactive Content:', 9);
        console.log('\n🔐 Login Credentials:');
        console.log('  Email: sara.wilson@university.edu');
        console.log('  Password: password123');
        console.log('\n✅ You can now log in and view the course!');
        console.log('='.repeat(60) + '\n');
