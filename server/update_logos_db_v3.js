...
const logos = [
    { name: 'Infosys', logo: 'https://www.vectorlogo.zone/logos/infosys/infosys-ar21.svg', type: 'corporate', order: 1 },
    { name: 'TCS', logo: 'https://www.vectorlogo.zone/logos/tcs/tcs-ar21.svg', type: 'corporate', order: 2 },
...
const updateLogos = async () => {
    try {
        ...
        console.log('Inserted new corporate logos with VectorLogoZone SVGs');
        process.exit(0);
    } catch (error) {
        console.error(error);
        process.exit(1);
